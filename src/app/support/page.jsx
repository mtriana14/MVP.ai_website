...
const Support = () => {
  return (
    <main
      className="w-full min-h-screen bg-[#1A2E5C] text-white overflow-x-hidden"
      aria-labelledby="support-title"
    >
      <div className="w-screen leading-none">
        <Image
          src={support_img}
          alt="MVP.ai support banner"
          priority
      ...
      <section className="flex flex-col items-center text-center px-6 py-12">
        <h1
          id="support-title"
          className="md:text-[64px] text-[40px] font-bold mb-4 font-dm px-4"
        >
          Need Help? We’ve Got You.
        </h1>
        <p className="md:text-[35px] text-[16px] w-[90%] md:w-[60%] font-urbanist px-4 font-medium [overflow-wrap:anywhere]">
          We’re here to make sure your MVP.ai experience is smooth, fun, and
          glitch-free. If you run into any issues, our team is ready to help.
        </p>
      ...
      >
        <h2
          ...
          className="md:text-[64px] text-[40px] text-center font-bold mb-4 font-dm px-4"
        >
        ...
        <p className="md:text-[35px] text-[16px] w-[90%] md:w-[60%] font-urbanist px-4 font-medium mb-[12px] [overflow-wrap:anywhere]">
          Please email us at{" "}
          <a
            href="mailto:mvp.ai.customersupport@youraimvp.com"
            className="underline"
          >
        ...
        <div className="bg-[rgba(230,230,230,0.4)] border-8 border-[#000000] rounded-[18px] p-7 w-[92%] md:max-w-4xl shadow-md">
          <ul
            className="space-y-4 text-[24px] font-urbanist text-[#161616] font-extrabold py-5 list-disc list-inside"
            aria-label="Support email checklist"
          >
      ...
      <section
        ...
        aria-labelledby="support-next-title"
      >
        <h2
          id="support-next-title"
          className="md:text-[48px] text-[40px] font-bold mb-12 font-dm"
        >
          What Happens Next
        </h2>
      ...
      >
        <h2
          ...
          className="md:text-[48px] text-[40px] font-semibold mb-6 font-dm"
        >
        ...
        <p className="md:text-[22px] text-[16px] font-urbanist w-[90%] md:w-[40%] font-semibold mb-6">
          ...
          or consult with Kai, your website companion — you might find the
          answer instantly.
        </p>
      </section>
    </main>
