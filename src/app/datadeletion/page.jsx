  ...
  return (
    <div className="bg-[#1A2E5C] p-5 w-full overflow-x-hidden h-full">
      <div className="mx-auto flex flex-col">
        <h1 className="ml-[18px] text-white text-[64px] font-bold mb-4 font-dm">
          Request for Account & Data Deletion
        </h1>

        <p className="font-urbanist text-white text-[28px] font-light ml-[28px] mb-12 w-[70%]">
        ...
        <div className="flex items-center ml-[92px] mt-12 w-[70%] gap-2">
          <p className="font-urbanist text-white text-[30px] font-medium">
