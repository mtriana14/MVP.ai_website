    ...
    <div className="bg-[#1E0E62] lg:p-3 p-5 w-full overflow-x-hidden">
      <div className="xl:w-[90%] mx-auto flex items-center justify-between">
        ...
        <div className="hidden md:block flex items-center justify-center space-x-4">
          ...
          {/* Updated this line */}
          <a href="/privacy-policy.pdf" target="_blank" rel="noopener noreferrer" className="text-white font-bold underline underline-offset-2 decoration-[1px] cursor-pointer ml-2">
            Privacy Policy
          </a>
        </div>
        ...
        {isMenuOpen && (
          <div className="fixed inset-0 z-50 bg-white flex flex-col overflow-hidden">
            ...
            <div className="flex justify-between px-4 pb-4 text-sm text-gray-600 font-dm font-bold">
              ...
              <a href="/privacy-policy.pdf" target="_blank" rel="noopener noreferrer" className="underline underline-offset-2">
                Privacy Policy
              </a>
