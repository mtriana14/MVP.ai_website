    ...
    <div className="bg-[#1A2E5C] lg:p-3 p-5 w-full overflow-x-hidden">
      <div className="xl:w-[90%] mx-auto flex items-center justify-between">
        ...
        <div className="hidden md:block space-x-4">
          ...
          <a href="/privacy" className={linkStyle("/privacy")}>
            Privacy Policy
          </a>
          <a href="/datadeletion" className={linkStyle("/datadeletion")}>
            Data
          </a>
        </div>
        ...
        {isMenuOpen && (
          <div className="fixed inset-0 z-50 bg-white flex flex-col overflow-hidden">
            ...
            <div className="relative flex-1 flex items-center justify-center w-full overflow-hidden">
              <Image src="/assets/top_left.png" alt="Top Left" width={400} height={400}
                className="absolute top-[70px] left-0 w-[160px] sm:w-[180px] md:w-[200px]" />
              <Image src="/assets/top_right.png" alt="Top Right" width={400} height={400}
                className="absolute top-[70px] right-0 w-[160px] sm:w-[180px] md:w-[200px]" />
              <Image src="/assets/bottom_left.png" alt="Bottom Left" width={400} height={400}
                className="absolute bottom-[70px] left-0 w-[160px] sm:w-[180px] md:w-[200px]" />
              <Image src="/assets/bottom_right.png" alt="Bottom Right" width={400} height={400}
                className="absolute bottom-[70px] right-0 w-[160px] sm:w-[180px] md:w-[200px]" />
              <div className="flex flex-col items-center justify-center h-full gap-2">
                <a href="/" className={`text-4xl md:text-6xl font-bold z-10 ${pathname === "/" ? "underline" : ""}`}>
                  Home
                </a>
                <a href="/datadeletion" className={`text-4xl md:text-6xl font-bold z-10 ${pathname === "/datadeletion" ? "underline" : ""}`}>
                  Data
                </a>
              </div>
            </div>
            <div className="flex justify-between px-4 pb-4 text-sm text-gray-600 font-dm font-bold">
              <a href="/privacy" className={`underline underline-offset-2 ${pathname === "/privacy" ? "font-black" : ""}`}>
                Privacy Policy
              </a>
