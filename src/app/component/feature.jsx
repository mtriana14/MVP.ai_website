  ...
  return (
    <section className="relative" aria-labelledby="features-title">
      <div className="bg-[#1A2E5C] lg:p-3 -mt-1 px-5 pt-5 z-0 lg:pb-0 pb-10 relative lg:h-[600px] w-full">
        <h2
          id="features-title"
          className="text-[#6CD5F6] font-bold pt-10 text-center text-[35px] lg:text-[65px]"
        >
          The Features
        </h2>
          ...
          {FeatureData && FeatureData.length > 0 ? (
            FeatureData.map((item, index) => (
              ...
              >
                ...
                />
                <h3 className="text-white font-semibold text-[20px] lg:text-[28px] mt-5 mb-4">
                  {item.title}
                </h3>
                <p className="text-white text-[13px] lg:text-[18px]">{item.para}</p>
              </motion.article>
            ))
          ) : (
            <p className="text-white text-center">Loading features...</p>
          )}
        </div>
      </div>
      <div className="bg-gradient-custom lg:px-10 -mt-1 lg:pt-10 h-[500px] lg:h-screen relative">
        <Image
          src="/assets/pics.svg"
          alt="Illustrations showcasing MVP.ai features"
          width={100}
          height={100}
        ...
        <Image
          ...
          alt="Mobile illustration of MVP.ai features"
          width={100}
          height={100}
